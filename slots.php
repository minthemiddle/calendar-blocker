...
$currentTime = Carbon::createFromFormat('Hi', $working_hours['day_start'], date_default_timezone_get());
$end = Carbon::createFromFormat('Hi', $working_hours['day_end'], date_default_timezone_get());
